...
- Change sound files, themes, or settings via the config file.
- Easily extend for custom beats or feedback.

## Contributing

Pull requests and issues are welcome! Feel free to fork and submit improvements, bug fixes, or feature requests.
